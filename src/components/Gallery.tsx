...
{ src: outdoorBorecGin, title: "Outdoor Setup", desc: "Mobilný bar v prírode", rotation: 'rotate(90deg) scale(1.1)' },
{ src: outdoorProfessorado, title: "Festival Bar", desc: "Profesionálny servis na festivaloch", rotation: 'rotate(90deg) scale(1.1)' },
{ src: momGinBottles, title: "Prémiové Značky", desc: "Široký výber kvalitných nápojov", rotation: 'rotate(90deg) scale(1.1)' }];
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          ...
          <div
            ...
            style={{ animationDelay: `${index * 100}ms` }}>
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-primary/80 via-primary/20 to-transparent opacity-60 group-hover:opacity-80 transition-opacity duration-300 my-0 mx-0 px-[10px] py-[10px]" />
